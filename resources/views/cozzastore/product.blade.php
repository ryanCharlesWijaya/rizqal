...
<!--===============================================================================================-->	
	<link rel="icon" href="{{ url('images/icons/favicon.png') }}"/>
<!--===============================================================================================-->
		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".Jilbab">
						Jilbab
					</button>
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".Cadar">
						Cadar
					</button>
				</div>
			</div>
			...
			<div class="row isotope-grid">
				...
				<div class='col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ $datas->kategori }}'>
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="{{ asset('storage/'.$datas->gambarProduk) }}" alt="IMG-PRODUCT">
						</div>
